...
// Server-side routing. ensure all filters are wrapped with if(Meteor.isClient)
...
Router.route('/api/posts', {
    ...
    name: 'apiPosts',
    action: function(){
        // all this function does is output the content our the post collection by returning the stringified JSON data
